...
<div class="modal fade" id="editPwdModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			...
			<ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li class="menu-list nav-active"><a href=""><i
					...
					<ul class="sub-menu-list">
						...
						<li class="active"><a href="${APP_PATH }/turn_add_guide"> 导入导游</a></li>
						</c:if>
					</ul></li>
	...
	<div class="main-content">
		...
		<!-- page heading start-->
		<div class="page-heading">批量导入金牌导游</div>
		<!-- page heading end-->
					...
					<table style="margin-left: 10px; margin-top: 10px" >
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success btn-sm"
								href="${APP_PATH }/guide/download/?filename=金牌导游导入模板.xlsx" id="btn_download">模板下载</a></td>
						</tr>
					</table>
				</form>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#btn').click(function() {
				if (checkData()) {
					$('#form1').ajaxSubmit({
						url : '${APP_PATH}/guide/uploadexcels',
						dataType : 'text',
